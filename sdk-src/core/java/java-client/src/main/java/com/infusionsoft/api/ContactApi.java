...
public class ContactApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updatePropertiesOnContactUsingPATCH1Call(Long contactId, InfusionsoftCreateOrPatchContact contact, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = contact;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updatePropertiesOnContactUsingPATCH1ValidateBeforeCall(Long contactId, InfusionsoftCreateOrPatchContact contact, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updatePropertiesOnContactUsingPATCH1Call(contactId, contact, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InfusionsoftFullContact updatePropertiesOnContactUsingPATCH1(Long contactId, InfusionsoftCreateOrPatchContact contact) throws ApiException {
        ApiResponse<InfusionsoftFullContact> resp = updatePropertiesOnContactUsingPATCH1WithHttpInfo(contactId, contact);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InfusionsoftFullContact> updatePropertiesOnContactUsingPATCH1WithHttpInfo(Long contactId, InfusionsoftCreateOrPatchContact contact) throws ApiException {
        com.squareup.okhttp.Call call = updatePropertiesOnContactUsingPATCH1ValidateBeforeCall(contactId, contact, null, null);
        Type localVarReturnType = new TypeToken<InfusionsoftFullContact>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updatePropertiesOnContactUsingPATCH1Async(Long contactId, InfusionsoftCreateOrPatchContact contact, final ApiCallback<InfusionsoftFullContact> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updatePropertiesOnContactUsingPATCH1ValidateBeforeCall(contactId, contact, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InfusionsoftFullContact>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
