...
public class ContactApiTest {
    ...
    public void listContactsUsingGETTest() throws ApiException {
        ...
        String since = null;
        String until = null;
        InfusionsoftContactList response = api.listContactsUsingGET(limit, offset, email, givenName, familyName, order, orderDirection, since, until);
    ...
    public void updatePropertiesOnContactUsingPATCH1Test() throws ApiException {
        ...
        InfusionsoftFullContact response = api.updatePropertiesOnContactUsingPATCH1(contactId, contact, updateMask);
