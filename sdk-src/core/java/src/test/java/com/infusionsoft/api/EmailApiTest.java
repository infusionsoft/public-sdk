...
public class EmailApiTest {
    ...
    public void listEmailsUsingGETTest() throws ApiException {
        ...
        Long contactId = null;
        String email = null;
        String sinceSentDate = null;
        String untilSentDate = null;
        InfusionsoftEmailSentQueryResultList response = api.listEmailsUsingGET(limit, offset, contactId, email, sinceSentDate, untilSentDate);
