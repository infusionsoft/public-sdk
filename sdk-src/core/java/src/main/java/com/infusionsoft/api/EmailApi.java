...
public class EmailApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listEmailsUsingGETCall(Integer limit, Integer offset, Long contactId, String email, String sinceSentDate, String untilSentDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (sinceSentDate != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("since_sent_date", sinceSentDate));
        if (untilSentDate != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("until_sent_date", untilSentDate));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listEmailsUsingGETValidateBeforeCall(Integer limit, Integer offset, Long contactId, String email, String sinceSentDate, String untilSentDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = listEmailsUsingGETCall(limit, offset, contactId, email, sinceSentDate, untilSentDate, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InfusionsoftEmailSentQueryResultList listEmailsUsingGET(Integer limit, Integer offset, Long contactId, String email, String sinceSentDate, String untilSentDate) throws ApiException {
        ApiResponse<InfusionsoftEmailSentQueryResultList> resp = listEmailsUsingGETWithHttpInfo(limit, offset, contactId, email, sinceSentDate, untilSentDate);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InfusionsoftEmailSentQueryResultList> listEmailsUsingGETWithHttpInfo(Integer limit, Integer offset, Long contactId, String email, String sinceSentDate, String untilSentDate) throws ApiException {
        com.squareup.okhttp.Call call = listEmailsUsingGETValidateBeforeCall(limit, offset, contactId, email, sinceSentDate, untilSentDate, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listEmailsUsingGETAsync(Integer limit, Integer offset, Long contactId, String email, String sinceSentDate, String untilSentDate, final ApiCallback<InfusionsoftEmailSentQueryResultList> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listEmailsUsingGETValidateBeforeCall(limit, offset, contactId, email, sinceSentDate, untilSentDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InfusionsoftEmailSentQueryResultList>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
